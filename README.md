...
<img alt="Shop Banner" src="banner.png" style="max-width: 800px; width: 100%; border-radius: 12px;"/>
</div>
...
<p class="text-lg">
    ...
    <a class="text-red-400 underline" href="https://t.me/magazin_muhicha2" target="_blank">
      @magazin_muhicha2
    </a>
</p>
</section><footer class="text-center mt-12 py-6 text-sm text-gray-500">
